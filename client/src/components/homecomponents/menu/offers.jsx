...
function offers() {
  return (
    <div className="bottom  pb-5 mb-4 border-b-2">
      ...
      <div className="offers mt-3 flex gap-2 rounded-[7px] bg-[#ffffff] border shadow-sm hover:shadow-md transition-all"> 
        ...
        <div className="text-container">
          <h3>50% off on Queen Room</h3>
          <h5>Book before 30-06-2024</h5>
          <h5>Hurry up!</h5>
        </div>
      </div>
      <div className="offers mt-3 flex gap-2 rounded-[7px] bg-[#ffffff] border shadow-sm hover:shadow-md transition-all">
